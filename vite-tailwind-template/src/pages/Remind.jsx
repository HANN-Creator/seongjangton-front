...
const Remind = () => {
  ...
  const feedbackMap = {
    "시간 부족":
      "매일 자기 전 5분도 활용해 루틴을 실천해보세요. 정해진 틀 안에서 시작하면 실천 가능성이 높아져요.",
    "의욕 부족":
      "루틴과 현재 목표의 연결고리를 떠올려 보세요. 연결고리가 선명하면 루틴에 의욕이 생겨요.",
    "낮은 동기부여":
      "가장 부담없고 쉬운 루틴부터 시작해보세요. 작은 성공 경험은 루틴의 동기가 될 수 있어요.",
    "효과 부족":
      "루틴을 통해 얻고 싶은 구체적인 변화를 떠올려 보세요. 원하는 변화가 명확하면 동기가 생겨요.",
    "목표에 맞는 루틴 구성":
      "루틴이 현재 목표 달성에 어떤 도움을 주고 있는지 되짚어보세요. 목표에 적합한 루틴은 동기를 유지시켜 줘요.",
    성취감:
      "스스로에게 작지만 의미 있는 보상을 시도해보세요. 성취의 기쁨은 루틴 지속의 큰 힘이 돼요.",
    "스스로에 대한 피드백":
      "루틴을 하며 느끼는 점을 기록해보세요. 루틴의 가치와 의미를 발견할 수 있어요.",
    "뚜렷한 목표 설정":
      "명확하고 방향성 있는 목표는 루틴 실천의 강력한 이유가 될 수 있어요.",
  };
